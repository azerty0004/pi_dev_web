    ...
    <form action="" method="POST">
        <table border="1" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="name" id="name" value="<?php echo $user['nom']; ?>" maxlength="20"></td>
            </tr>
            <tr>
                <td>
                ...
                <td><input type="tel" name="phone" id="phone" value="<?php echo $user['telephone']; ?>" maxlength="20"></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="password" id="password" value="<?php echo $user["mdp"]; ?>">
                </td>
            </tr>
            <tr>
                <td></td>
