...
function sortUsers($criteria) {
    ...
    $sql = "SELECT * from pidev.utilisateurs ORDER BY $criteria";
    $req = $db->prepare($sql);
    try {
        $req->execute();
        $result = $req->fetchAll();
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link  active" href="sortUsers.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Tri</span>
          </a>
        </li>

        <li class="nav-item">
        <a class="nav-link  active" href="searchUser.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Recherche</span>
          </a>
        </li>
...
<form action="" method="GET">
    <div class="sortForm">
        ...
        <select id="etat" name="criteria" required>
            ...
            <option value="role">Tri selon le rôle</option>
            <option value="telephone">Tri selon le numéro de tel</option>
            <option value="email">Tri selon l'email</option>
            <option value="nom">Tri selon le nom</option>
        </select>
    </div>
